...
const startTag = '{/* Print Document Content */}';
const endTag = '{/* MODAL: RETOUR MARCHANDISE */}';

const startIndex = code.indexOf(startTag);
const endIndex = code.indexOf(endTag);

if (startIndex !== -1 && endIndex !== -1) {
    const replacement = `{/* Print Document Content */}
            <div className="p-8 space-y-6 bg-white text-black font-sans text-xs">
              ...
              <div className="grid grid-cols-3 gap-4 h-32">
                ...
                <div className="border border-black p-2 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-10 pt-4 pointer-events-none">
